    ...
    class NetMgr {
        ...
        change2test(callback) {
            return __awaiter(this, void 0, void 0, function* () {
                this.selectNode(() => {
                    this.type = 2;
                    BlackCat.tools.CoinTool.id_SGAS = "0xf5630f4baba6a0333bfb10153e5f853125465b48";
...
(function (BlackCat) {
    class MyInfoView extends BlackCat.ViewBase {
        ...
        getArea() {
            return BlackCat.Main.langMgr.get("area_code_" + BlackCat.Main.user.info.region) ? BlackCat.Main.langMgr.get("area_code_" + BlackCat.Main.user.info.region) : BlackCat.Main.langMgr.get("modifyArea_empty");
        }
        doLogout() {
            BlackCat.ViewConfirm.callback = () => {
                this.makeLogout();
